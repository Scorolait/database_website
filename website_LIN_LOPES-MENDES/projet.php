...
<head>
  ...
  <title>Projet C2i : Accueil</title>
</head>
...
<body>
  ...
  <p id="p">Travaillez pour réussir !</p>
  <p class="phrase">"Il y a souvent plus de choses naufragées au fond d'une âme qu'au fond de la mer."<br>Victor Hugo</p>
  <p class="phrase">"La mer est aussi profonde dans le calme que dans la tempête."<br>John Donne</p>
